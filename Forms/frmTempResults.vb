...
Public Class frmTempResults
    ...
    Private Sub OpenToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenToolStripMenuItem.Click
        ...
        OpenFileDialog1.Filter = "Body Composition Profile Files (*.bcp)|*.bcp|Text Files (*.txt)|*.txt|Rich Text Files (*.rtf)|*.rtf|All Files (*.*)|*.*"
        'Display dialog
        If OpenFileDialog1.ShowDialog() = Windows.Forms.DialogResult.OK Then
            'If OKed, Open the .txt file and dipslay it in the tempresults window in the DemoOputputBox.
            DemoOutputBox.Text = My.Computer.FileSystem.ReadAllText(OpenFileDialog1.FileName)
        End If
    End Sub
    ...
    Private Sub SaveToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SaveToolStripButton.Click
        ...
        SaveFileDialog1.FileName = frmDevMode.NameBox.Text + ""
        ...
        If SaveFileDialog1.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            My.Computer.FileSystem.WriteAllText(SaveFileDialog1.FileName, DemoOutputBox.Text, False)
        End If
    End Sub
    ...
    Private Sub printdocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles printdocument1.PrintPage
        ...
        e.Graphics.MeasureString(Mid(DemoOutputBox.Text, intCurrentChar + 1), font, _
                    New SizeF(intPrintAreaWidth, intPrintAreaHeight), fmt, _
                    intCharsFitted, intLinesFilled)
        e.Graphics.DrawString(Mid(DemoOutputBox.Text, intCurrentChar + 1, intCharsFitted), font, _
            Brushes.Black, rectPrintingArea, fmt)
        intCurrentChar += intCharsFitted
        If intCurrentChar < DemoOutputBox.Text.Length Then
            e.HasMorePages = True
        Else
    ...
    Private Sub CopyToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CopyToolStripButton.Click
        ...
        Me.DemoOutputBox.SelectionStart = 0
        Me.DemoOutputBox.SelectionLength = 4000
        Me.DemoOutputBox.Copy()
    End Sub
End Class